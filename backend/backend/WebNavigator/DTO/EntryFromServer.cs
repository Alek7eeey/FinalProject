...
{
    public class EntryFromServer
    {
        public EntryFromServer() { }
        public EntryFromServer(string name, string type, string description, string parentName, string childNodeName) 
        {
            Name = name;
            Type = type;
